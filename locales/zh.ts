export default {
  hero: {
    ...
    sub: "17岁，从八年级开始编程，脑子里同时开着大约六个标签页，一个都没关。但依然能交付真实的东西：为初创公司、自由职业客户构建生产级应用和AI智能体，还有3,700多人安装了我构建的东西。有一件我真心喜欢自己的事：一旦决定做某件事，我就会完成它，无论遇到什么阻碍。有一件我不喜欢的：我特别擅长出于纯粹的好奇心开启新项目，但这份好奇心一旦大脑感到无聊就会迅速消失。",
    cta: {
      primary: "查看部署项目",
      copied: "已复制",
      copyEmail: "复制邮箱",
