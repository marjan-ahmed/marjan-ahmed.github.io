export default {
  hero: {
    ...
    eyebrow: "معمار · ایجنٹک AI",
    headline: "مجھے مسئلہ دو، میں سسٹم بنا کر لاؤں گا۔",
    ...
    card: {
      role: "معمار — ایجنٹک AI سسٹمز",
      base: "مقام",
      local: "مقامی وقت",
      focus: "فوکس",
      focusValue: "ایجنٹک AI سسٹمز",
      status: "حالت",
      statusValue: "شراکت کے لیے تیار",
    },
  },
  proof: {
    title: "ثبوت",
  ...
  roadmap: {
    eyebrow: "روڈ میپ",
    body: "میری روڈ میپ میں سب سے پہلے: Forward-Deployed-Engineer Agent Factory (FDE-AF) ماڈل پر ایک AI-نیٹو کمپنی بنانا، ایسے ایجنٹس جو حقیقی کمپنیوں میں تعینات ہوں، ڈیمو نہیں۔ پرجوش اسٹارٹ اپس کے ساتھ شراکت داری ابھی سے شروع ہوتی ہے۔",
    disclaimer: "اس صفحے کے باقی حصوں کی طرح ثبوت نہیں — یہ ایک سمت ہے۔",
  },
  palette: {
    label: "کمانڈ پیلیٹ",
  ...
  contact: {
    title: "رابطہ",
    letsConnect: "مسئلہ میرے پاس لائیں",
    description: "اگر آپ AI اسٹارٹ اپ ہیں، دنیا میں کہیں بھی، اور ایک طویل مدتی پارٹنر کی تلاش میں ہیں جو سسٹم کو اسکیل اپ تک سنبھالے، کوئی نیا ملازم نہیں، تو یہی وہ چیز ہے جس کی تلاش ہے۔ {email} یا {linkedin} پر رابطہ کریں۔",
    emailLink: "ای میل",
